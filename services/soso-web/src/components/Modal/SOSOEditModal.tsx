...
const SOSOEditModal: React.FC<Props> = ({ isOpen, onClose, onSave, initialData }) => {
  ...
  return (
    <div className='fixed inset-0 bg-black/50 overflow-y-auto z-50 h-full w-full flex items-center justify-center'>

...
func SetupRouter(cfg *Config) *echo.Echo {
	...
	eveG.POST("/:event_id/participate", eventH.RegisterParticipant)
	eveG.POST("/:event_id/go-driver", eventH.RegisterGoDriver)
	eveG.POST("/:event_id/return-driver", eventH.RegisterReturnDriver)
	eveG.POST("/:event_id/both-driver", eventH.RegisterBothDriver)
	eveG.POST("/:event_id/go-rider", eventH.RegisterGoRider)
	eveG.POST("/:event_id/return-rider", eventH.RegisterReturnRider)
	eveG.POST("/:event_id/both-rider", eventH.RegisterBothRider)
